...
const PreviewVideo = ({ videoData, isVisible, isHovered, tipo }: Props) => {
    ...
    return (
        <div className={`previewVideoContent ${styles.previewVideoContent}`}>
            <Link href={`/${videoData.marca?.slug}/${tipo}/${videoData.slug}` || ''}>
                <div className={`bodyVideoContent ${styles.bodyVideoContent}`}>
                    <div className={`imgVideoPreivew ${styles.imgVideoPreivew}`} ref={placeholderPopupRef}>
                        <Image
                            src={videoData.image || ''}
                ...
                <div className={`footerVideoContent ${styles.footerVideoContent}`}>
