...
const TabsPro = ({ productoData }: Props) => {
                ...
                <div className="">
                    <div className={styles.headerContainerMovil} ref={wrapperRef}>
                        <div className={styles.listTabs} ref={containerRef}>
                            <div
                                className={`${0 === activeTab ? styles.active : ''}`}
                                onClick={() => setActiveTab(0)}
                            >
                                DESCRIPCIÓN
                            </div>
                            <div
                                className={`${1 === activeTab ? styles.active : ''}`}
                                onClick={() => setActiveTab(1)}
                            >INGREDIENTES
                            </div>
                            <div
                                className={`${2 === activeTab ? styles.active : ''}`}
                            ...
                            </div>
                            {
                                productoData.receta_nombre && productoData.receta_nombre != '' && (
                                    <div
                                        className={`${3 === activeTab ? styles.active : ''}`}
                                ...
                                (0 === activeTab) && (
                                    <div className={`${0 === activeTab ? styles.activeContent : ''}`}>
                                        <div className={styles.infoBox2}>
                                            <div>
                                                <HtmlSafeRender html={productoData.descripcion ?? ''} className="contenidoHTML Pro" />
                                            </div>
                                        </div>
                                    </div>
                                )
...

                            {
                                (1 === activeTab) && (
                                    <div className={`${1 === activeTab ? styles.activeContent : ''}`}>
                                        <div className={styles.infoBox2}>
                                            <div>
                                                <HtmlSafeRender html={productoData.ingredientes ?? ''} className="contenidoHTML Pro" />
                                            </div>
                                        </div>
                                    </div>
                                )
...

                            {
                                (2 === activeTab) && (
                                    <div className={`${2 === activeTab ? styles.activeContent : ''}`}>
                                        <div className={`${styles.infoBox2}`}>
                                            <HtmlSafeRender html={productoData.informacion_nutricional ?? ''} className="contenidoHTML Pro" />
                                        </div>
                                    </div>
                                )
                            }
                                        ...
                                        <div className={styles.infoBox2}>
                                            <div className={styles.recetasContainer}>
                                                ...
                                                <div className={styles.viewRecetaPanel}>
                                                    <HtmlSafeRender html={productoData.receta_ingredientes ?? ''} className="contenidoHTML Pro" />
                                                    <HtmlSafeRender html={productoData.receta_instrucciones ?? ''} className="contenidoHTML Pro" />
                                                </div>
