            ...
            <div className='containerFluid'>
                <div className={styles.energiaHeader}>
                    ...
                    <div>
                        ...
                        <h2>
                            Damos un paso firme hacia <br />un futuro más sostenible <br />incorporando
                            <span> paneles <br />solares en nuestras <br />operaciones</span>
                        </h2>
                        <p>
                            Aprovechamos la radiación solar para generar energía, <br />producir de manera responsable, reducir nuestra huella de <br />carbono y cuidar el planeta.
                        </p>
                    </div>
                </div>
