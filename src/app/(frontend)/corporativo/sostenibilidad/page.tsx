...
const Sostenibilidad = () => {
    ...
    const dataDescripcion = `
        <p class=''>En Gloria somos conscientes del impacto que generan nuestras acciones y por eso nos preocupamos en operar bajo sólidos estándares de protección del medioambiente y de los recursos naturales. </p>
