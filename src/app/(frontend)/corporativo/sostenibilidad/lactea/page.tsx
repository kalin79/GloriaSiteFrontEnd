...
const Lactea = () => {
    ...
    const dataInfo = {
        photo: '/logoSF.svg',
        descripcionCorta: `<p class='celesteTxt'>Somos miembro internacion del Marco de Sostenibilidad Láctea </p>
