...
export default async function MarcaPage() {
    ...
    const { videos, productos, campanas, banner }: { videos: VideosHomeInterface[], productos: ProductInterface[], campanas: CampanaInterface[], banner: VideoInterface } = response.data;
    ...
    return (
        <>
            ...
            <ListadoProductosComponent products={productos} />
